    ...
    public Felter (Spiller spiller){
        ...
        //"Bræt" med egenskaber
            switch(felt){ // Terningernes sum der afgører placeringen på brættet
                ...
                case 9: spiller.addToTotal(60);
                    feltBeskrivelse = "Bjerghytterne\t\t+60";
                    break;

                case 10: spiller.addToTotal(-80);
